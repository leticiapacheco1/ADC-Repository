...
**B_dot** contains the detumbling control law and its hardware interface, including the IMU driver, magnetometer calibration, and the Raspberry Pi to H-bridge to magnetorquer chain.

**STK_MATLAB_Simulation** contains the STK and MATLAB simulation used to validate the B-dot controller against a modeled DARLA-02 spin state before it ran on hardware.

**Box Test** holds the experimental validation work, including the suspended test article campaign and the Helmholtz cage testing that followed it.
